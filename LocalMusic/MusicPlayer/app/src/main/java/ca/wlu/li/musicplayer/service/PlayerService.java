...
import ca.wlu.li.musicplayer.activity.PlayerActivity;
import ca.wlu.li.musicplayer.custom.LrcProcess;
import ca.wlu.li.musicplayer.domain.AppConstant;
import ca.wlu.li.musicplayer.domain.LrcContent;
...
public class PlayerService extends Service {
    ...
    public static final String MUSIC_CURRENT = "com.lmy.action.MUSIC_CURRENT";      //当前音乐播放时间更新动作
    public static final String MUSIC_DURATION = "com.lmy.action.MUSIC_DURATION";//新音乐长度更新动作
    public static final String SHOW_LRC = "com.lmy.action.SHOW_LRC";                        //通知显示歌词
    ...
    public void onCreate() {
        ...
        MusicUtil musicUtil = new MusicUtil(PlayerService.this);
